...
import { FcPackage, FcSettings, FcDeployment, FcLock } from "react-icons/fc";
import {
  FaNpm,
  FaGitAlt,
  FaCogs,
...
- **[`@1fe/cli`](https://www.npmjs.com/package/@1fe/cli)** - CLI tools for 1fe development and build infrastructure
- **[`@1fe/server`](https://www.npmjs.com/package/@1fe/server)** - 1fe server runtime and hosting infrastructure
- **[`@1fe/shell`](https://www.npmjs.com/package/@1fe/shell)** - Core application shell and runtime framework

**Development Tools:**

- **[`@1fe/create-1fe-app`](https://www.npmjs.com/package/@1fe/create-1fe-app)** - CLI tool to quickly scaffold a new 1fe instance
- **[`@1fe/starter-app`](https://www.npmjs.com/package/@1fe/starter-app)** - Quickly bootstrap a new project with Vite Boilerplate

**Configuration & Utilities:**

- **[`@1fe/sample-widget-base-config`](https://www.npmjs.com/package/@1fe/sample-widget-base-config)** - A shared configuration package providing base settings and environment configurations for 1fe widgets. This package standardizes widget development configurations across the 1fe ecosystem

## <FaNpm style={{ display: 'inline', marginRight: '0.5rem', verticalAlign: 'middle', color: '#CB3837' }} /> NPM.org Organization Setup
...
### <FaGitAlt style={{ display: 'inline', marginRight: '0.5rem', verticalAlign: 'middle', color: '#F05032' }} /> Changeset Workflow for Version Management
...
3. **<FaCogs style={{ display: 'inline', marginRight: '0.5rem', color: '#2E8B57' }} /> How CI/CD Processes Changesets**  
   When you merge your branch, the CI/CD pipeline automatically:

   **<FaDownload style={{ display: 'inline', marginRight: '0.5rem', color: '#4169E1' }} /> During Merge:**
   ...
   **<FaRocket style={{ display: 'inline', marginRight: '0.5rem', color: '#FF6347' }} /> Publishing Process:**
...
Once you've published a package, you can install it in your 1fe application by adding it to your `package.json` file.

## Next Steps

After setting up NPM registry:

1. [Set up Configuration Service](/how-to-guides/infrastructure-setup/configuration-setup/)
2. [Implement CI/CD Integration](/how-to-guides/infrastructure-setup/project-setup/)
3. [Configure Widget Development Environment](/tutorials/developing-your-first-widget/getting-started/)
