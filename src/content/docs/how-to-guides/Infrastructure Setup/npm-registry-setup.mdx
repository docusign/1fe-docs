...
1. [Set up Configuration Service](/how-to-guides/infrastructure%20setup/configuration-setup/)
2. [Implement CI/CD Integration](/how-to-guides/infrastructure%20setup/project-setup/)
