...
• <FaMicrosoft style={{ display: 'inline', marginRight: '0.5rem', color: '#0078D4' }} /> **Hosting Service:** Where your 1fe application will run ([Azure Web App explained here](/how-to-guides/infrastructure%20setup/hosting-setup/))

• <FaCloud style={{ display: 'inline', marginRight: '0.5rem', color: '#1F8BF3' }} /> **Deployment Target:** CDN or cloud storage for hosting widget bundles ([CDN Setup explained here](/how-to-guides/infrastructure%20setup/cdn-setup/))

• <FaMicrosoft style={{ display: 'inline', marginRight: '0.5rem', color: '#0078D4' }} /> **Configuration Management:** Key-value stores for live configuration settings ([Configuration Management explained here](/how-to-guides/infrastructure%20setup/configuration-setup/))

• <FaNpm style={{ display: 'inline', marginRight: '0.5rem', color: '#CB3837' }} /> **Private NPM Registry:** Internal registry for publishing and consuming widget packages ([NPM Registry Setup explained here](/how-to-guides/infrastructure%20setup/npm-registry-setup/))
