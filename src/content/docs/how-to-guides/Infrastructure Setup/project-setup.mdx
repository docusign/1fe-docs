...
• <FaGithub style={{ display: 'inline', marginRight: '0.5rem', color: 'var(--sl-color-text)' }} /> **Version Control:** To track code changes and enable collaboration (we use `GitHub`)

• <FaMicrosoft style={{ display: 'inline', marginRight: '0.5rem', color: '#0078D4' }} /> **Hosting Service:** Where your 1fe application will run ([Azure Web App explained here](/how-to-guides/infrastructure-setup/hosting-setup/))

• <FaCloud style={{ display: 'inline', marginRight: '0.5rem', color: '#1F8BF3' }} /> **Deployment Target:** CDN or cloud storage for hosting widget bundles ([CDN Setup explained here](/how-to-guides/infrastructure-setup/cdn-setup/))

• <FaMicrosoft style={{ display: 'inline', marginRight: '0.5rem', color: '#0078D4' }} /> **Configuration Management:** Key-value stores for live configuration settings ([Configuration Management explained here](/how-to-guides/infrastructure-setup/configuration-setup/))

• <FaNpm style={{ display: 'inline', marginRight: '0.5rem', color: '#CB3837' }} /> **Private NPM Registry:** Internal registry for publishing and consuming widget packages ([NPM Registry Setup explained here](/how-to-guides/infrastructure-setup/npm-registry-setup/))

• <FaGithub style={{ display: 'inline', marginRight: '0.5rem', color: 'var(--sl-color-text)' }} /> **CI/CD Automation platform:** CI/CD platforms for automation (we use `GitHub Actions`)
...
### <FaGithub style={{ display: 'inline', marginRight: '0.5rem', verticalAlign: 'middle', color: 'var(--sl-color-text)' }} /> Quick Start with GitHub Actions
...
### <FaGithub style={{ display: 'inline', marginRight: '0.5rem', verticalAlign: 'middle', color: 'var(--sl-color-text)' }} /> 1.1 Secrets Management
...
### <FaGithub style={{ display: 'inline', marginRight: '0.5rem', verticalAlign: 'middle', color: 'var(--sl-color-text)' }} /> CI/CD Platforms

• <FaGithub style={{ display: 'inline', marginRight: '0.5rem', color: 'var(--sl-color-text)' }} /> **GitHub Actions:** [GitHub Actions Documentation](https://docs.github.com/en/actions) (recommended)
...
• <SiVercel style={{ display: 'inline', marginRight: '0.5rem', color: 'var(--sl-color-text)' }} /> **Vercel** / <SiNetlify style={{ display: 'inline', marginRight: '0.5rem', color: '#00C7B7' }} /> **Netlify:** [Vercel Documentation](https://vercel.com/docs), [Netlify Documentation](https://docs.netlify.com/)
...
• <FaLock style={{ display: 'inline', marginRight: '0.5rem', color: 'var(--sl-color-text)' }} /> **HashiCorp Vault:** [Vault Documentation](https://www.vaultproject.io/docs)
...
1. [Configure Widget Development Environment](/tutorials/developing-your-first-widget/getting-started/)
2. [Deploy Your First Widget](/tutorials/setup-and-deploy-1fe-poc/deploy-poc/)
3. [Explore Platform Utilities](/reference/platform-utilities/overview/)
