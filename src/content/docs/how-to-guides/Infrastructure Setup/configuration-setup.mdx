...
**For GitHub Actions:**
Add this connection string as a repository secret. For detailed instructions on configuring this and other required secrets, see the [Secrets Management section](/how-to-guides/infrastructure%20setup/project-setup/#11-secrets-management) in the CI/CD Pipeline setup guide.
...
- <FaLock
    style={{ display: "inline", marginRight: "0.5rem", color: "#000000" }}
  /> **HashiCorp Vault**
- <SiConsul
...
1. [Implement CI/CD Integration](/how-to-guides/infrastructure%20setup/project-setup/)
