...
import { SiGooglecloud, SiConsul, SiRedis } from "react-icons/si";
import {
  FaFileCode,
  FaCog,
  FaKey,
...
**For GitHub Actions:**
Add this connection string as a repository secret. For detailed instructions on configuring this and other required secrets, see the [Secrets Management section](/how-to-guides/infrastructure-setup/project-setup/#11-secrets-management) in the CI/CD Pipeline setup guide.
...
- <FaMicrosoft
    style={{ display: "inline", marginRight: "0.5rem", color: "#0078D4" }}
...
- <FaLock
  ...
  /> **HashiCorp Vault**
- <SiConsul
    style={{ display: "inline", marginRight: "0.5rem", color: "#CA2171" }}
  /> **Consul**
- <FaKey
    style={{ display: "inline", marginRight: "0.5rem", color: "#419EDA" }}
  /> **etcd**
- <SiRedis
    style={{ display: "inline", marginRight: "0.5rem", color: "#DC382D" }}
  /> **Redis**
...
1. [Implement CI/CD Integration](/how-to-guides/infrastructure-setup/project-setup/)
2. [Configure Widget Development Environment](/tutorials/developing-your-first-widget/getting-started/)
