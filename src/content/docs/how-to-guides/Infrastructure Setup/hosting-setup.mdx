...
1. [Configure CDN for Widget Bundles](/how-to-guides/infrastructure%20setup/cdn-setup/)
2. [Set up Configuration Service](/how-to-guides/infrastructure%20setup/configuration-setup/)
3. [Set up NPM Registry](/how-to-guides/infrastructure%20setup/npm-registry-setup/)
4. [Set up CI/CD Pipeline](/how-to-guides/infrastructure%20setup/project-setup/)
