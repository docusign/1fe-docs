...
A Widget is ANY snippet of javascript logic that runs in a browser. A Widget lives in its own GitHub repository, owns its own end-to-end CICD pipeline, and release management (all of which is orchestrated by 1FE), and runs perfectly well in the 1FE BathTub, a Widget, or a Plugin.
...
Sample structure of props can be seen in the 1FE BathTub’s props editor.
