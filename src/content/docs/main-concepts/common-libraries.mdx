...
description: Common Libraries within 1fe
sidebar:
  order: 5
---

1fe supports webpack externals via the 1fe/cli. This enables widgets to exclude common libraries from output bundles.
...
The version string you see in a widget’s package.json file is an illusion of control. At runtime, when the widget is rendered by the 1fe shell, the 1fe/shell will load the version specified within the live configurations instead.
