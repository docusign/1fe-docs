...
A Widget lives in its own GitHub repository, owns its own end-to-end CICD pipeline, and release management (all of which is orchestrated by 1FE), and runs perfectly well in the 1FE BathTub, a Widget, or a Plugin.

A widget is never permitted to be an IIFE.

# Types of Widgets

### <FcBookmark style={{ display: 'inline', marginRight: '0.5rem', verticalAlign: 'middle' }} /> Plugin
...
### <FcLock style={{ display: 'inline', marginRight: '0.5rem', verticalAlign: 'middle' }} /> Pinned
