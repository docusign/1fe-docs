...
In the above section, you explored the example starter plugin. Let's override that example plugin to use your plugin running locally.
...
In the previous step, you overrode the example plugin to use your local plugin. Now let's look at how to host your plugin locally so it shows up by deafult in the 1fe instance.
...
You'll also need the playground widget for your 1fe instance. The playground widget provides essential development tooling and runtime utilities.
...
1.  Fork this [mock-cdn-assets](https://github.com/docusign/mock-cdn-assets/tree/main) repository
    This repository contains the live configurations and widget assets per environment that power [demo.1fe.com](https://demo.1fe.com). You will use this as a jumping off point to get your own version of the assets.
...
### Use the new widget assets in your 1fe instance

One of the key features of 1fe is the ability to dynamically load widgets and plugins via [Live Configurations](../../main-concepts/live-configurations). We will now take advantage of these configurations to get your local 1fe instance to get the config's from your local CDN.
...
You've successfully set up local development for your 1fe widgets! You can move on to the next section if you want to deploy your 1fe instance quickly to showcase its benefits to your team. Or, you can use the links below to jump to different sections to learn more.
