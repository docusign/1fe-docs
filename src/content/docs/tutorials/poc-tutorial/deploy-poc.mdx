...
Now that we have setup our local 1fe instance and widget starter kit, it's time to deploy our setup to showcase its benefits. This will allow us to share our work with others and demonstrate the power of 1fe. We will do the following in this guide.
...
- **[Productionize Your Setup](/how-to-guides/productionize/)** - Move beyond POC to production-ready infrastructure
...
- **[Learning Section](/learning/)** - Dive deeper into 1fe concepts and architecture
- **[How-to Guides](/how-to-guides/)** - Solve specific implementation challenges
- **[Reference](/reference/)** - Access technical documentation and API references

---

## 📞 Need Help?

- **Questions?** Check our [FAQs](/learning/faqs/)
- **Terminology unclear?** Visit our [Terminology guide](/reference/terminology/)
- **Technical issues?** Reference our [API documentation](/reference/)
