...
Platform infrastructure can be complex - the 1fe community is here to support you:

<div class="prose">

- **💬 Platform Questions** - Join our [Community Discussions](https://github.com/docusign/1fe/discussions) for architecture and implementation guidance
- **🐛 Infrastructure Issues** - Report problems on [GitHub Issues](https://github.com/docusign/1fe/issues)
- **📚 Technical References** - Check our [How-to Guides](/how-to-guides/) and [Reference](/reference/) sections
- **❓ General Questions** - Visit our [FAQs](/learning/faqs/) for common platform team questions
