...
One of the key features of 1fe is the ability to dynamically load widgets and plugins via [Live Configurations](/learning/live-configurations/). We will now take advantage of these configurations to get our local 1fe instance to get the config's from our local CDN.
...
**→ [Step 3: Deploy Your Proof of Concept](/tutorials/setup-and-deploy-1fe-poc/deploy-poc/)**
