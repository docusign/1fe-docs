...
3.  **What just happened?**
    ...
    2.  When `utils.context.get` was clicked, the plugin loaded a child _widget_ via the magic of **platform utilities**! ✨ **[See what other utilities](/reference/platform-utilities/overview/)** are in your toolkit.

</div>

:::tip[The Magic Behind the Scenes 🎭]
1fe loads the latest widget bundles and assets from a **CDN** - pretty cool, right? This means your widgets can update independently without touching the main app! **[Discover how this magic works](/learning/externalized-libraries/)** 🪄
:::
