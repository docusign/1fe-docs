...
We are using public tooling in this guide to get something out on the internet so you can showcase your 1fe instance. If you're ready to set up a production environment with proper CDN infrastructure, CI/CD pipelines, and robust hosting, visit our [productionization guide](/tutorials/productionize-your-1fe-instance/).
:::
...
1.  Point your 1fe instance to the new CDN assets for **live configurations**. Live configurations let you update widget versions, library versions, and dynamic settings without redeploying your 1fe instance - the configs are fetched at runtime! **[Find out more here](/learning/live-configurations/)**
