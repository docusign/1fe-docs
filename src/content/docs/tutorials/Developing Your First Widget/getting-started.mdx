...
Wait, what's a **[widget](/learning/widgets/)**? 🤔 And what's this **[starter kit](https://github.com/docusign/1fe-widget-starter-kit)** all about? Click to find out!
...
Notice that `platformProps` in there? That's your widget's toolkit! 🧰 **[Discover all the cool utilities](/reference/platform-utilities/overview/)** you get for free.

### Widget Contract (`src/contract.ts`)

This is your **widget contract** - think of it as the "handshake" between your widget and the platform. Curious about **[how contracts work](/learning/widgets/#contracts)**? 🤝
...
This little file is actually quite powerful - it controls how your widget is built and deployed! Want to know **[what else it can do](/reference/1fe-config-reference/)**? ⚙️
...
**Important:** This command needs a running **1fe instance** to work. Don't have one yet? No worries! Check out **[what a 1fe instance is](/learning/what-is-1fe/)** 🏗️ and then follow [Tutorial 1: Setup and Deploy a 1fe POC](/tutorials/setup-and-deploy-1fe-poc/) to get your instance up and running locally.
:::
...
And there it is - your widget will open in the **1fe Playground**! Think of it as your widget's sandbox where it can play safely. Want to explore **[what the playground can do](/learning/playground/)**? 🛝
