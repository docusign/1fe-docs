...
import { FcBookmark, FcSettings, FcEngineering, FcOrganization } from "react-icons/fc";

## <FcBookmark style={{ display: 'inline', marginRight: '0.5rem', verticalAlign: 'middle' }} /> Terminology
...
## <FcSettings style={{ display: 'inline', marginRight: '0.5rem', verticalAlign: 'middle' }} /> Core Concepts
...
## <FcEngineering style={{ display: 'inline', marginRight: '0.5rem', verticalAlign: 'middle' }} /> Technical Components
...
## <FcSettings style={{ display: 'inline', marginRight: '0.5rem', verticalAlign: 'middle' }} /> Development Tools
...
## <FcOrganization style={{ display: 'inline', marginRight: '0.5rem', verticalAlign: 'middle' }} /> Package References
