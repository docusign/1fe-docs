---
title: CI/CD Pipeline Connection
...
This guide shows how to tie together your hosting service, configuration management, and CDN deployment into a cohesive CI/CD pipeline using GitHub Actions. This assumes you have already set up the individual infrastructure components.
