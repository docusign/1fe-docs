...
`defaultRoute`: The default route to load when no route is provided. Bathtub will be the default route if enabled. Otherwise, this will be the default route.
