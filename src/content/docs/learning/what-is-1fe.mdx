...
import { FcSettings, FcDeployment, FcElectronics } from "react-icons/fc";
...
## <FcSettings style={{ display: 'inline', marginRight: '0.5rem', verticalAlign: 'middle' }} /> Development
...
## <FcDeployment style={{ display: 'inline', marginRight: '0.5rem', verticalAlign: 'middle' }} /> Deployment
...
## <FcElectronics style={{ display: 'inline', marginRight: '0.5rem', verticalAlign: 'middle' }} /> Execution
