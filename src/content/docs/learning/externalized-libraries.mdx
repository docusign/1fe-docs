...
import { FcPackage, FcFlashOn, FcSettings } from "react-icons/fc";

## <FcPackage style={{ display: 'inline', marginRight: '0.5rem', verticalAlign: 'middle' }} /> Externalized Libraries

1fe supports webpack externals via the 1fe/cli. This allows widgets to exclude common libraries from output bundles.

### <FcFlashOn style={{ display: 'inline', marginRight: '0.5rem', verticalAlign: 'middle' }} /> Why Externalize Libraries?
...
### <FcSettings style={{ display: 'inline', marginRight: '0.5rem', verticalAlign: 'middle' }} /> How are libraries externalized within 1fe?
